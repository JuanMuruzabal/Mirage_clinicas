...
// `panel-texture` (TR-013 en docs/Arquitectura y base/tradeoffs.md) es la textura de fondo
...
//     ver el comentario ahí — sexta vuelta, TR-029 en docs/Arquitectura y base/tradeoffs.md,
...
//     docs/Arquitectura y base/tradeoffs.md): antes `<main>` solo scrolleaba vertical y cada
...
//   - `PanelShell` (octava corrección, TR-031 en docs/Arquitectura y base/tradeoffs.md)
...
//   - `.panel-main-h` (novena corrección, TR-032 en docs/Arquitectura y base/tradeoffs.md):
