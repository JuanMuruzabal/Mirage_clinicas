...
| # | Qué | Termina cuando |
|---|---|---|
| 3.2.1 | Esquema y migración — **en curso**. ✅ paso 1: baja de las tablas legacy del MVP (13 filas, TR-132). Pendientes: renombre `profesional_id`→`clinic_id`, roles acumulables, `atendido_por_user_id`, EXCLUDE mudado | La suite pasa sin cambios de comportamiento: nadie nota nada desde la UI |
