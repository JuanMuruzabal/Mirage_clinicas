...
| 3.2.4 | Colaboradores: invitar por código o mail, roles con exclusión. El invitado sin cuenta se crea una con perfil de "actividades de la clínica" (3.2.3) si no atiende pacientes · **"Otras clínicas" pasa a mostrar las invitaciones pendientes de confirmar** (pedido del cliente 2026-09-13): `GET /me/clinicas` hoy filtra `status = 'active'`, y ese filtro es el que cambia | Se puede armar una clínica de varios |
