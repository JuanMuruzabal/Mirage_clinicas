...
**Estado:** los seis PRs implementados (PP-6 sin mergear); quedan H22 y H25–H27 · **Fecha:** 2026-09-25 · **Alcance:** `/personalizar-pagina`, `ClinicaPublicaTemplate` y `packages/prisma-engine`. Nada del panel de gestión ni del wizard de turno (salvo el botón que lo abre).
...
| PP-6 | `feature/pp-6-editor-simple` | H18, H20, H21, H23 — TR-173 | implementado |
